# work-coordinates Specification

## Purpose

Establish and manage the machine's spatial reference: run the GRBL homing cycle, set and return to a work origin, display machine and work positions, surface homing configuration, and verify axis orientation on the page.
