# machine-status Specification

## Purpose

Continuously observe the plotter's runtime state by polling GRBL status, parsing status reports, and exposing live machine position and state to the rest of the app.
