# manual-control Specification

## Purpose

Give the operator direct manual control of the plotter: jogging the carriage, cancelling jog motion, raising and lowering the pen via the Z axis, and adjusting machine calibration settings that drive these behaviors.
